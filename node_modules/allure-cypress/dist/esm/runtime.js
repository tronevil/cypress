...
import { getMessageAndTraceFromError, getStatusFromError, getUnfinishedStepsMessages, isPromise, serialize } from "allure-js-commons/sdk";
...
import { dropCurrentTest, enqueueRuntimeMessage, getConfig, getCurrentTest, getRuntimeMessages, setCurrentTest, setRuntimeMessages } from "./state.js";
...
export var reportCommandStart = command => {
  ...
  enqueueRuntimeMessage({
    ...
    data: {
      ...
      args: command.attributes.args.map(arg => serialize(arg, {
